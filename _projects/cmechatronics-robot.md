...
**Below picture of our circuit followed by a labelled diagram of the circuit:**
<img src="{{ '/assets/images/Wiring.jpg' | relative_url }}" alt="Robot Wiring" style="max-width: 700px; width: 100%; height: auto; display: block; margin: 2rem auto;">
