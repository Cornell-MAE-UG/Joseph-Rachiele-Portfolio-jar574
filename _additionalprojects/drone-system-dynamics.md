...
description: Drone System Dynamics
technologies: [MATLAB]
image: /assets/images/drone.jpg
---

For the final groupwork assignment in my System Dynamics class (MAE 3260), we were given the option to analyze the dynamics of any system. My group decided on a drone. We dissected the drone in order to analyze the dynamics and controls of the system. The following is short summary of our findings.
...
![Photo of Drone Electric]({{ "/assets/images/DroneElectric.jpg" | relative_url }}){: .inline-image-l}
